    ...
    return PagedPlugin = (function(_super) {
      ...
      PagedPlugin.prototype.extendTemplateData = function(opts) {
        ...
        templateData.getPageCollection = function(collectionName, start, finish) {
          var collection, subCollection, _ref, _ref1;
          if (collectionName == null) {
            collectionName = 'html';
          }
          collection = this.getCollection(collectionName);
          if (start == null) {
            start = ((_ref = this.document.page) != null ? _ref.startIdx : void 0) || 0;
          }
          if (finish == null) {
            finish = ((_ref1 = this.document.page) != null ? _ref1.endIdx : void 0) || collection.models.length;
          }
        ...
        templateData.getPageUrl = function(pageNumber, document) {
          var err, page, pageDocument, pageId, pageUrl, relativePath, _ref;
          if (document == null) {
            document = this.getDocument();
          }
          page = document.get('page');
          if (pageNumber == null) {
            pageNumber = (_ref = page != null ? page.number : void 0) != null ? _ref : 0;
          }
      ...
      PagedPlugin.prototype.removePagesFor = function(document, collection, next) {
        var database, docpad, filePath, pages, tasks, _ref;
        docpad = this.docpad;
        database = docpad.getDatabase();
        filePath = document.getFilePath();
        pages = ((_ref = document.get('page')) != null ? _ref.pages : void 0) || [];
        if (pages.length === 0) {
            ...
            if (numberOfPages > 1) {
              return (function() {
                ...
                return addTask(function(complete) {
                  var pageDocument, pageFilename, pageOutFilename, pageRelativePath, _ref;
                  ...
                  pageDocument = (_ref = typeof docpad.cloneModel === "function" ? docpad.cloneModel(document) : void 0) != null ? _ref : document.clone();
